...
function GamePage() {
    ...
    const typeMatchups = {
        ...
        steel: {
            ...
            reistances: ['normal','grass,','ice','flying','psychic','bug','rock','dragon','steel','fairy']
        },
        fairy: {
    ...
    const handleTypeMatchUps = (e) => {
        ...
        //only when that if is passed then we have hit a super effective hit.                  
            ...
            const currentResistances1st = typeMatchups[currentPokemontype]?.reistances;
            const currentResistances2nd = typeMatchups[currentPokemonSndType]?.reistances;
